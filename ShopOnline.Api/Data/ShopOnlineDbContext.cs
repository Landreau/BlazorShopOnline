    ...
    public class ShopOnlineDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(new Product
            {
                Id = 24,
                Name = "Laptop Dell",
                Description = "Dell (15,6 Zoll Full-HD Notebook (" +
                "Intel® Quad N5100 4x2.80 GHz, 16GB DDR4, 1000 GB SSD, " +
                "Intel UHD, HDMI, Webcam, Bluetooth, USB 3.0, WLAN, Windows 11 Prof",
                ImageURL = "/Images/Electronic/Dell.png",
                Price = 560,
                Qty = 16,
                CategoryId = 3
            });
            ...
            modelBuilder.Entity<Product>().HasData(new Product
            {
                Id = 25,
                Name = "X",
                Description = "X - available in most sizes",
                ImageURL = "/Images/Shoes/Shoes7.png",
                Price = 65.99m,
                Qty = 42,
                CategoryId = 4
            });
